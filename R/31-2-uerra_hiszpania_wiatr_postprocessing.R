...
fr_buffer = st_buffer(fr, dist = 0.15)
...
plot(poryw_over_15)
plot(a, add = TRUE)
raster::writeRaster(poryw_over_15, filename = "~/github/kinga-grad/data/hiszpania_wiatr/uerra/poryw_over_15.tif", overwrite = TRUE)

poryw_over_175 = terra::mask(mean(rast("poryw_over_175.nc"), na.rm=T), a)
poryw_over_175 = terra::crop(poryw_over_175, a)
plot(poryw_over_175)
plot(a, add = TRUE)
raster::writeRaster(poryw_over_175, filename = "~/github/kinga-grad/data/hiszpania_wiatr/uerra/poryw_over_175.tif", overwrite = TRUE)

poryw_over_20 = terra::mask(mean(rast("poryw_over_20.nc"), na.rm=T), a)
poryw_over_20 = terra::crop(poryw_over_20, a)
plot(poryw_over_20)
plot(a, add = TRUE)
raster::writeRaster(poryw_over_20, filename = "~/github/kinga-grad/data/hiszpania_wiatr/uerra/poryw_over_20.tif", overwrite = TRUE)
...
plot(poryw_over_25)
plot(a, add = TRUE)
raster::writeRaster(poryw_over_25, filename = "~/github/kinga-grad/data/hiszpania_wiatr/uerra/poryw_over_25.tif", overwrite = TRUE)
...
plot(poryw_over_30)
plot(a, add = TRUE)
raster::writeRaster(poryw_over_30, filename = "~/github/kinga-grad/data/hiszpania_wiatr/uerra/poryw_over_30.tif", overwrite = TRUE)
...
plot(a, add = TRUE)
raster::writeRaster(wind_max, filename = "~/github/kinga-grad/data/hiszpania_wiatr/uerra/poryw_avg_annual_max.tif", overwrite = TRUE)
...
plot(a, add = TRUE)
raster::writeRaster(wind_max2, filename = "~/github/kinga-grad/data/hiszpania_wiatr/uerra/poryw_max_record.tif", overwrite = TRUE)
...
plot(wind_max_10lat)
plot(a, add = TRUE)
raster::writeRaster(wind_max_10lat, filename = "~/github/kinga-grad/data/hiszpania_wiatr/uerra/poryw_max_na_10_lat.tif", overwrite = TRUE)
...
plot(wind_q99)
plot(a, add = TRUE)
raster::writeRaster(wind_q99, filename = "~/github/kinga-grad/data/hiszpania_wiatr/uerra/poryw_roczny_percentyl99.tif", overwrite = TRUE)
